...
export default {
  ...
  methods: {
    selected () {
      ...
      } else if (this.allQuestions[this.index].Options[1]) {
        console.log('option1 = ', this.allQuestions[this.index].Options[1])
        if (this.ansText[1] === '') {
      ...
      if (selectDone === true) {
        ...
        for (let i = 0; i < 4; i++) {
          if (this.ansText[i] !== '' && this.allQuestions[this.index].Answers[i]) {
            ...
            if (tmp1.trim().toUpperCase() === this.allQuestions[this.index].Answers[i].toUpperCase()) {
        ...
        if (this.ansText[0].trim().toUpperCase() === this.allQuestions[this.index].Answers[0].toUpperCase()) {
          if (this.ansText[1] !== '' && this.allQuestions[this.index].Answers[1]) {
            if (this.ansText[1].trim().toUpperCase() === this.allQuestions[this.index].Answers[1].toUpperCase()) {
              this.ansCorrect = true
            } else {
              this.ansCorrect = false
            }
