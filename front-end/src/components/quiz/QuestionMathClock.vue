...
export default {
  ...
  computed: {
    ...
    clock1: function () {
      return (this.currentQuestion) ? this.currentQuestion.Clocks[0] : ''
    },
    clock2: function () {
      return (this.currentQuestion) ? this.currentQuestion.Clocks[1] : ''
    },
    isClock2: function () {
      if (this.currentQuestion.Clocks.length > 1) {
        return true
      } else {
        return false
      }
