...
export default {
  ...
  computed: {
    ...
    learnWords: function () {
      return (this.allQuestions[this.index]) ? JSON.parse(this.allQuestions[this.index].Tag[0]) : ''
    },
    questionType: function () {
      return (this.allQuestions[this.index]) ? this.allQuestions[this.index].QuestionType : ''
    },
    wordType: function () {
      return (this.allQuestions[this.index]) ? this.allQuestions[this.index].Tag[1] : ''
    }
  },
  watch: {
